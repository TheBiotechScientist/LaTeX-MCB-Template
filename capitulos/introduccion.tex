...
Este es un ejemplo de código python en línea con el texto:

% {\small\mint{python}{import numpy as np}}

% Y aquí un ejemplo de código latex en línea con el texto: {\mint{tex}{\documentclass[12pt,towside]{book}}}
